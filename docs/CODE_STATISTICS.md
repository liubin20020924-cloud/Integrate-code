...
|| 模块 | 文件 | 行数 | 功能 ||
||--------|------|------|------||
|| 主应用 | app.py | 256 | Flask 应用初始化、蓝图注册 ||
|| 配置管理 | config.py | 231 | 环境变量、数据库配置 ||
...
|| Trilium 集成 | trilium_helper.py | 478 | 笔记搜索、内容获取 ||
|| 知识库工具 | kb_utils.py | 139 | 数据库查询工具 ||
...
|| 知识库管理 | kb_management_bp.py | 321 | ~12 ||
|| 工单系统 | case_bp.py | 787 | ~15 ||
|| 统一用户 | unified_bp.py | 407 | ~8 ||
|| 认证 API | auth_bp.py | 201 | ~4 ||
|| API 路由 | api_bp.py | 278 | ~3 ||
|| **小计** | **8 文件** | **2,504 行** | **~57 端点** ||
...
|| 文档 | 行数 | 内容 ||
||--------|------|------||
|| README.md | 577 | 项目概述、快速开始 ||
|| docs/README.md | 135 | 文档索引 ||
...
||------|--------|------|-----|----|----|----|----| ----- ||
|| / (根目录) | 487 | 0 | 0 | 0 | 577 | 0 | 0 | 1,064 ||
|| common/ | 1,741 | 0 | 0 | 0 | 0 | 0 | 0 | 1,741 ||
|| routes/ | 2,504 | 0 | 0 | 0 | 0 | 0 | 0 | 2,504 ||
|| services/ | 418 | 0 | 0 | 0 | 0 | 0 | 0 | 418 ||
|| scripts/ | 837 | 0 | 0 | 0 | 0 | 0 | 0 | 837 ||
|| templates/ | 0 | 11,143 | 0 | 0 | 0 | 0 | 0 | 11,143 ||
|| static/ | 0 | 0 | 2,281 | 88 | 0 | 0 | 0 | 2,369 ||
|| docs/ | 0 | 0 | 0 | 0 | 4,598 | 0 | 279 | 4,877 ||
|| database/ | 0 | 0 | 0 | 0 | 0 | 397 | 0 | 397 ||
|| **总计** | **5,087** | **11,143** | **2,281** | **88** | **5,175** | **397** | **279** | **23,873** ||
...
|| 文件类型 | 文件数量 | 总行数 | 占比 ||
||---------|---------|--------|------||
|| **Python (.py)** | 29 | **5,087** | 21.3% ||
|| **HTML (.html)** | 20 | **11,143** | 46.7% ||
|| **CSS (.css)** | 7 | **2,281** | 9.6% ||
|| **JavaScript (.js)** | 1 | **88** | 0.4% ||
|| **Markdown (.md)** | 17 | **5,175** | 21.7% ||
|| **SQL (.sql)** | 2 | **397** | 1.7% ||
|| **Nginx Config (.conf)** | 3 | **279** | 1.2% ||
|| **总计** | **79** | **23,873** | **100%** ||
